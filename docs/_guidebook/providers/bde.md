...
- Index policy: `discovery_indexes()` (code=BM25; title/description=hybrid). With ~15.5k entries, embedding memory and build time are the consideration.
