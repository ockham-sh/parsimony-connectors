# Changelog — parsimony-polymarket

All notable changes to `parsimony-polymarket` will be documented in this file. The
...
- Credential-declaration conformance tests (`tests/test_credential_declaration_polymarket.py`)
