...
async def _get_catalog(catalog_url: str | None = None) -> Catalog:
    ...
    url = catalog_url or os.environ.get(PARSIMONY_BDP_CATALOG_URL_ENV, _DEFAULT_CATALOG_URL)
...
class BdpSearchParams(BaseModel):
    ...
    catalog_url: str | None = Field(default=None, description="Override catalog URL, e.g. file:///tmp/bdp.")
