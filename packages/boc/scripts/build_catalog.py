    ...
    return Catalog(
        ...
        indexes=[
            ...
            HybridIndex(
                ...
                fusion=ZScoreFusion(weights={"title_bm25": 0.6, "title_vector": 1.0}),
            ),
            HybridIndex(
                "description_hybrid",
                field="description",
                ...
                fusion=ZScoreFusion(weights={"description_bm25": 0.5, "description_vector": 0.8}),
            ),
        ],
        default_field="title",
    )
...
async def build(*, save: str | None, push: str | None) -> Catalog:
    ...
    if save is not None:
        await catalog.save(save, builder="packages/boc/scripts/build_catalog.py")
    if push is not None:
        await catalog.save(push, builder="packages/boc/scripts/build_catalog.py")
    return catalog
...
def main() -> None:
    ...
    parser.add_argument("--push", help="Catalog URL to push, e.g. hf://parsimony-dev/boc.")
