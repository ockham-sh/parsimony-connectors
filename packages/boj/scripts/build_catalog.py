"""Build the Bank of Japan catalog snapshot."""
...
from parsimony_boj import BojEnumerateParams, enumerate_boj
...
async def build(*, save: str | None, push: str | None) -> Catalog:
    ...
    if push is not None:
        await catalog.save(push, builder="packages/boj/scripts/build_catalog.py")
    return catalog
...
def main() -> None:
    ...
    parser.add_argument("--push", help="Catalog URL to push, e.g. hf://parsimony-dev/boj.")
