...
_BOJ_DATABASES: tuple[tuple[str, str, str], ...] = (
    ("IR01", "Interest Rates on Deposits and Loans", 'The Basic Discount Rates and Basic Loan Rates (Previously Indicated as "Official Discount Rates")'),
    ("IR02", "Interest Rates on Deposits and Loans", "Average Interest Rates Posted at Financial Institutions by Type of Deposit"),
    ...
    ("FM06", "Financial Markets", "Trading of Interest-bearing Government Bonds by Purchaser (Interest-bearing Government Bonds)"),
    ("FM07", "Financial Markets", "(Reference)Government Bonds Sales Over the Counter / Counter Sales Ratio (through January 2004)"),
    ...
    ("MD06", "Money, Deposits and Loans", "Sources of Changes in Current Account Balances at the Bank of Japan and Market Operations (Final Figures)"),
    ...
    ("MD12", "Money, Deposits and Loans", "Deposits, Vault Cash, and Loans and Bills Discounted by Prefecture (Domestically Licensed Banks)"),
    ...
    ("LA05", "Money, Deposits and Loans", "Senior Loan Officer Opinion Survey on Bank Lending Practices at Large Japanese Banks"),
    ...
    ("BIS", "Balance of Payments and BIS-Related Statistics", "BIS International Locational Banking Statistics and BIS International Consolidated Banking Statistics in Japan"),
