...
All notable changes to `parsimony-alpha-vantage` will be documented in this file. The
...
- Every connector now declares `requires=("ALPHA_VANTAGE_API_KEY",)` — the env var
...
- Credential-declaration conformance tests (`tests/test_credential_declaration_alpha_vantage.py`,
