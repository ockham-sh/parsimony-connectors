...
from parsimony_treasury import TreasuryEnumerateParams, enumerate_treasury
...
async def build(*, save: str | None, push: str | None) -> Catalog:
    ...
    if save is not None:
        await catalog.save(save, builder="packages/treasury/scripts/build_catalog.py")
    if push is not None:
        await catalog.save(push, builder="packages/treasury/scripts/build_catalog.py")
    return catalog
