...
``dict`` (no ``OutputConfig``): the former is a deep nested XBRL blob meant for
...
FULL_TEXT_SEARCH_OUTPUT = OutputConfig(
    columns=[
        ...
        Column(name="filing_date", role=ColumnRole.DATA, dtype="datetime"),
        Column(name="cik", role=ColumnRole.DATA),
        Column(name="document", role=ColumnRole.DATA),
        Column(name="period_ending", role=ColumnRole.DATA, dtype="datetime"),
...
SUBMISSIONS_OUTPUT = OutputConfig(
    columns=[
        Column(name="accessionNumber", role=ColumnRole.KEY, namespace="sec_edgar"),
        Column(name="filingDate", role=ColumnRole.DATA, dtype="datetime"),
        Column(name="form", role=ColumnRole.DATA),
        Column(name="primaryDocument", role=ColumnRole.DATA),
        Column(name="reportDate", role=ColumnRole.DATA, dtype="datetime"),
    ]
)
...
COMPANY_CONCEPT_OUTPUT = OutputConfig(
    columns=[
        Column(name="end", role=ColumnRole.DATA, dtype="datetime"),
        Column(name="val", role=ColumnRole.DATA, dtype="numeric"),
        Column(name="unit", role=ColumnRole.DATA),
        Column(name="fy", role=ColumnRole.DATA),
        Column(name="fp", role=ColumnRole.DATA),
        Column(name="form", role=ColumnRole.DATA),
        Column(name="filed", role=ColumnRole.DATA, dtype="datetime"),
        Column(name="accn", role=ColumnRole.DATA),
        Column(name="start", role=ColumnRole.DATA, dtype="datetime"),
    ]
)
...
FINANCIAL_STATEMENT_OUTPUT = OutputConfig(
    columns=[
...
INSIDER_TRANSACTIONS_OUTPUT = OutputConfig(
    columns=[
        ...
        Column(name="shares", role=ColumnRole.DATA, dtype="numeric"),
        Column(name="price", role=ColumnRole.DATA, dtype="numeric"),
        Column(name="value", role=ColumnRole.DATA, dtype="numeric"),
        Column(name="remaining_shares", role=ColumnRole.DATA, dtype="numeric"),
    ]
)
...
HOLDINGS_13F_OUTPUT = OutputConfig(
    columns=[
